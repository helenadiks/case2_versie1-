...
def load_data():
    ...
    # Inkomenscategorieën toevoegen voor deelvraag 2 & 3
...
st.caption(
    "Tab 1 en 2 beantwoorden de twee deelvragen; tab 3 laat de geografische spreiding en het "
    "verloop per land zien ter ondersteuning; tab 4 legt de databronnen en opschoning uit."
)
...
# Tabbladen gekoppeld aan de deelvragen — volgorde en nummering matchen nu de deelvraag-volgorde
tab1, tab2, tab3, tab4 = st.tabs([
    "Deelvraag 1: Walk vs. Talk",
    "Deelvraag 2 & 3: Kuznets Curve",
    "Verkennend: Kaart & Tijdverloop",
    "Data & Methodologie",
])

# -----------------------------------------------------------------------------
# TAB 1: Walk vs. Talk (Deelvraag 1)
# -----------------------------------------------------------------------------
with tab1:
    ...
    st.markdown("""
    **Categorie-indeling:**
    - **Walk (onder y=0 & rechts van x=5):** Landen die hun aandeel hernieuwbare energie met meer dan 5 percentagepunten zagen stijgen én een effectieve daling in CO₂ per inwoner wisten te realiseren.
    - **Talk / Lag (boven y=0 & rechts van x=5):** Landen waar het aandeel hernieuwbare energie wel steeg, maar waar de totale vraag naar energie of de fossiele mix zo sterk groeide dat de CO₂-uitstoot per inwoner per saldo toch toenam.
    """)

# -----------------------------------------------------------------------------
# TAB 2: Environmental Kuznets Curve & Inkomensverschillen (Deelvraag 2 & 3)
# -----------------------------------------------------------------------------
with tab2:
...
# -----------------------------------------------------------------------------
# TAB 3: Geografische Spreiding & Tijdverloop (ondersteunend, geen aparte deelvraag)
# -----------------------------------------------------------------------------
with tab3:
    st.subheader(f"Geografische verdeling van hernieuwbare energie ({selected_year})")
    st.caption("Ter ondersteuning van deelvraag 1 en 2/3 — geen aparte deelvraag, maar aanvullend bewijs.")
